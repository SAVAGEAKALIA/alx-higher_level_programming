...
total_size = 0
stats_count = {200: 0, 301: 0, 400: 0, 401: 0, 403: 0, 404: 0, 405: 0, 500: 0}
line_count = 0
...
try:
    ...
    for line in sys.stdin:
        ...
        if len(elements) >= 2:
            ...
            if status_code in stats_count:
                stats_count[status_code] += 1
        ...
        if line_count % 10 == 0:
            ...
            for code, count in sorted(stats_count.items()):
                if count > 0:
